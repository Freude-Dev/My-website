  ...
  return (
    <div className="flex flex-col items-center overflow-x-hidden">
      <DashedCircle
        ...
        width={500} height={500} cx={0} cy={0}
        strokeWidth={3} r={400}
      />
        ...
        <div className="flex flex-col lg:grid lg:grid-cols-2 lg:gap-20 lg:items-center">
              ...
              {test.testimonials.slice(0, 5).map((item, index) => (
                <SwiperSlide key={index}>
                  <div className="pb-10">
                    ...
                    <blockquote className="relative border-l-2 border-orange-500/40 pl-5">
          ...
          <div className="mt-16 lg:mt-0 relative">
            <DashedCircle
              ...
              strokeWidth={2} r={130} color="white"
              motion={{ x: -10, y: -5, rotate: 8, duration: 6 }}
            />

            <p className="text-orange-500 text-xs tracking-[0.3em] uppercase font-medium mb-4 relative z-10">
              — By the numbers
            </p>
            ...
            <ul className="relative z-10 grid grid-cols-2 border border-zinc-800 rounded-2xl overflow-hidden">
              {STATS.map((stat, i) => (
                ...
                >
                  <div className="text-3xl sm:text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-amber-400 mb-2">
                    {stat.value}
                  </div>
